...
import com.springboot.blogapp.springboot_blogapp_rest_api.payload.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    //handle ResourceNotFoundException specific exceptions
    ...
    //handle blogAPI specific exceptions
    ...
    //Approach -1 to write custom validation response
    @Override
    ...
    //Approach -2 to write custom validation response
  /*  @ExceptionHandler(ResourceNotFoundException.class)
